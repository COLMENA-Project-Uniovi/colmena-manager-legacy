<?php
class ColmenaGroupsController extends AppController{
	public $name = "ColmenaGroups";
	...
	public function add() {
		...
		if ($this->request->is('post')) {
			...
			if(!$flag){
				$this->Session->setFlash(
					'<p>Grupo añadido correctamente.</p>',
					'flash_ok'
				);
	...
	public function edit($id = null, $locale = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			...
			if (!$flag) {
                $this->Session->setFlash(
                    '<p>Grupo editado correctamente.</p>',
                    'flash_ok'
                );
            }
        }
	...
	public function delete($id = null) {
        ...
        if (!$flag) {
            $this->Session->setFlash(
                '<p>Grupo eliminado correctamente.</p>',
                'flash_ok'
            );
        }
