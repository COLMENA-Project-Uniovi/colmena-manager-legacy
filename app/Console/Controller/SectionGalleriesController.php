...
class SectionGalleriesController extends AppController{
	...
	public function add($id) {
		...
		if ($this->request->is('post')) {
			...
			try{
				...
				return $this->redirect(array('action' => 'edit', $id, $this->SectionGallery->id, $part['SectionGallery']['locale']));
			}
			...
			return $this->redirect(array('controller' => 'sections', 'action' => 'edit', $id, $part['SectionGallery']['locale']));
		}
	...
	public function edit($id, $id_part) {
		...
		if ($this->request->is(array('post', 'put'))) {			
			...
			//redirection
			return $this->redirect(array('controller' => 'sections', 'action' => 'edit', $id, $this->request->data['SectionGallery']['locale']));
		}
