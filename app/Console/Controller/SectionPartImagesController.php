...
class SectionPartImagesController extends AppController{
	...
	public function add($id){
		...
		if ($this->request->is('post')) {
			...
			try{
				...
				return $this->redirect(array('action' => 'edit', $id, $this->SectionPartImage->id, $part['SectionPartImage']['locale']));
			}
			...
			return $this->redirect(array('controller' => 'sections', 'action' => 'edit', $id, $part['SectionPartImage']['locale']));
		}
	...
	public function edit($id, $id_part){
		...
		if ($this->request->is(array('post', 'put'))) {			
			...
			//redirection
			return $this->redirect(array('controller' => 'sections', 'action' => 'edit', $id, $this->request->data['SectionPartImage']['locale']));
		}
